...
namespace PromptlyBot
{
    ...
    public interface ITopic
    {
        ...
        /// </summary>
        /// <param name="context">An <c>ITurnContext</c> that represents the current conversational turn.</param>
        ...
        /// </remarks>
        Task OnReceiveActivity(ITurnContext context);
    ...
    public abstract class Topic<TState> : ITopic where TState : new()
    {
        ...
        /// <summary>
        /// See <see cref = "ITopic.OnReceiveActivity(ITurnContext)"/> for more details. 
        /// </summary>
        public abstract Task OnReceiveActivity(ITurnContext context);
